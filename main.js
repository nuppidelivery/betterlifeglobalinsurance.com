...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    pt: {
        ...
        "residencial_name": "Seguro Casa",
        "residencial_subtitle": "Sua casa protegida contra os imprevistos da vida.",
        "residencial_problem": "Sua casa representa uma parte importante do patrimônio da família. O Seguro Casa ajuda a reduzir os prejuízos quando incêndios, tempestades, roubos, acidentes ou outros eventos cobertos causam danos ao imóvel ou aos seus bens.",
        ...
        "umbrella_problem": "Alguns acidentes podem resultar em indenizações muito superiores aos limites do Seguro de Carro ou do Seguro Casa. O Umbrella acrescenta uma camada extra de responsabilidade civil para ajudar a proteger seu patrimônio.",
